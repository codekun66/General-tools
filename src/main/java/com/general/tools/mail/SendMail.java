...
public class SendMail {
    ...
    //发件人账户名
    public static String senderAccount = "xukun3";
    //发件人账户密码
    ...
    public static MimeMessage getMimeMessage(Session session) throws Exception{
        ...
        // 读取本地文件
        DataHandler dh = new DataHandler(new FileDataSource("src\\itellyours.png"));
        // 将图片数据添加到"节点"
        image.setDataHandler(dh);
        // 为"节点"设置一个唯一编号（在文本"节点"将引用该ID）
        image.setContentID("itellyours");

        // 6. 创建文本"节点"
        MimeBodyPart text = new MimeBodyPart();
        // 这里添加图片的方式是将整个图片包含到邮件内容中, 实际上也可以以 http 链接的形式添加网络图片
        text.setContent("这是一张图片<br/><a href='http://www.cnblogs.com/ysocean/p/7666061.html'><img src='cid:itellyours'/></a>", "text/html;charset=UTF-8");
